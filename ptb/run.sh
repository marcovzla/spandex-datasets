...
PTB=/home/marco/repos/datasets/ptb/treebank_3_LDC99T42
cp -R $PTB/treebank_3/parsed/mrg/wsj/ $HOME/nltk_data/corpora/ptb/WSJ
cp -R $PTB/treebank_3/parsed/mrg/brown/ $HOME/marco/nltk_data/corpora/ptb/BROWN
